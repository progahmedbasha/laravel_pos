...
<!-- 				<a class="desktop-logo logo-light active" href="#"><h1 style='color:#03a5fc;'>On Fast<i class='fas fa-shipping-fast' style='font-size:39px;color:#03a5fc'></i></h1></a>
 -->				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/logo.png')}}" class="main-logo" alt="logo"></a>
	...
	<!-- 					<li class="side-item side-item-category">Main</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="">كل المديرين</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="suppliers">كل الموردين</a></li>
							<li><a class="slide-item" href=""> الموردين المحزوفة</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="categories">كل الأصناف</a></li>
							<li><a class="slide-item" href=""> الحالات الأصناف</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="products">كل المنتجات</a></li>
							<li><a class="slide-item" href=""> المنتجات المحزوفة</a></li>
						</ul>
					</li>
	...
	<!-- 				<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="">كل المدن</a></li>
							<li><a class="slide-item" href=""> المدن المحزوفة</a></li>
						</ul>
					</li> -->
